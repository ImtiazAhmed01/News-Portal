...
const displayCategory = categories => {
    ...
    categories.forEach(category => {
        ...
        categoryLi.innerHTML = `<button onclick="categoryNewsShow('${category.category_id}', '${category.category_name}')" type="button" class="btn category-btn bg-dark text-white">${category.category_name}</button>
          `;
...
const displayModal = modalDetails => {
    ...
    modalContentCard.innerHTML = `
        <div class="modal-header d-flex flex-column align-items-center">
          ...
          <div>
          <img class="img-fuild w-25" src="${modalDetails.thumbnail_url}" alt="">
          </div>
        </div>
